...
- @kekonic/diagrams-core@1.0.0-rc.8
  - @kekonic/diagrams-geometry@1.0.0-rc.8
  - @kekonic/diagrams-icons@1.0.0-rc.8
  - @kekonic/diagrams-layout@1.0.0-rc.8
  - @kekonic/diagrams-render-svg@1.0.0-rc.8
  - @kekonic/diagrams-routing@1.0.0-rc.8
...
- 982f2c0: Keep state-machine final names readable: authored labels sit on the node fill with a hollow inner ring, and the live canvas inherits diagram `--kd-bg` so a light diagram is not drawn on a dark host.
...
- Updated dependencies [982f2c0]
  ...
  - @kekonic/diagrams-render-svg@1.0.0-rc.7
  - @kekonic/diagrams-layout@1.0.0-rc.7
  - @kekonic/diagrams-geometry@1.0.0-rc.7
  - @kekonic/diagrams-routing@1.0.0-rc.7
...
- Updated dependencies [981712f]
- Updated dependencies [981712f]
  - @kekonic/diagrams-routing@1.0.0-rc.6
  - @kekonic/diagrams-render-svg@1.0.0-rc.6
...
- 7a35d7a: Add group chrome shapes (`hexagon`, `circle`, `ellipse`, …) and `arrange: surround` for center-and-ring ports-and-adapters layouts.
...
- Updated dependencies [7a35d7a]
  ...
  - @kekonic/diagrams-render-svg@1.0.0-rc.5
  - @kekonic/diagrams-routing@1.0.0-rc.5
...
- Updated dependencies [1d5519f]
  ...
  - @kekonic/diagrams-render-svg@1.0.0-rc.4
...
- Updated dependencies [982bd4c]
  ...
  - @kekonic/diagrams-render-svg@1.0.0-rc.3
  - @kekonic/diagrams-layout@1.0.0-rc.3
  - @kekonic/diagrams-routing@1.0.0-rc.3
...
- Updated dependencies [27349fb]
  ...
  - @kekonic/diagrams-render-svg@1.0.0-rc.2
  - @kekonic/diagrams-routing@1.0.0-rc.2
  - @kekonic/diagrams-theme@1.0.0-rc.2
...
- Updated dependencies [2465ce7]
  ...
  - @kekonic/diagrams-render-svg@1.0.0-rc.1
  - @kekonic/diagrams-routing@1.0.0-rc.1
  - @kekonic/diagrams-theme@1.0.0-rc.1
