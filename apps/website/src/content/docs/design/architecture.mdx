...
[C4](https://c4model.com) is a set of zoom levels, not a second Kekonic dialect. Use the ordinary
language with one level per file:
...
Worked example of one platform at three levels:

- [Storefront — system context](/gallery/storefront-context/)
- [Storefront — containers](/gallery/storefront-containers/)
- [API application — components](/gallery/storefront-components/)
...
compiler will not stop you. The gallery examples keep them apart on purpose.
