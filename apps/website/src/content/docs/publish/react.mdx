---
title: React
description: Add a live diagram or editable playground to React without duplicating the Kekonic Diagrams rendering stack.
---
...
Changing `source` rerenders without remounting the viewport. For `kdiagram 2` models, pass `view`
