---
title: Web component
description: Embed a live diagram in any browser application with the framework-neutral `<k-diagram>` custom element.
---
...
The package includes the element’s structural styles, so this example needs no Kekonic Diagrams stylesheet.
