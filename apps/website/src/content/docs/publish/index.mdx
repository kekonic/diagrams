...
description: Choose the smallest Kekonic Diagrams integration that fits where your readers will see the diagram.
---

<div class="kd-lead">
  Keep `.kdiagram` as the source of truth, then choose delivery based on where the diagram will be
  read. Most destinations should receive static SVG; use a live host only when interaction changes
