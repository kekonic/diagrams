...
kdiagrams check architecture.kdiagrams --json
```
...
kdiagrams analyze architecture.kdiagrams --pretty
...
```bash
kdiagrams format architecture.kdiagrams --write
kdiagrams format diagrams/ --check
kdiagrams format diagrams/ --write
kdiagrams format input.kdiagrams --output formatted.kdiagram
...
```bash
kdiagrams ast architecture.kdiagrams --pretty
kdiagrams graph architecture.kdiagrams --pretty
```
