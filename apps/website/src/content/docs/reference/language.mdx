...
description: The KDiagram 1 syntax for flow and sequence diagrams, nodes, connections, groups, tables, policy blocks, styles, and animation.
---
...
optional; an omitted header selects KDiagram language version 1.
